...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('candidat_m2_r_s', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('candidat_m2_r_s');
    }
};
