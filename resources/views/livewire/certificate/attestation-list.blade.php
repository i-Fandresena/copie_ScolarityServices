                ...
                <tbody>
                    @foreach($attestations as $attestation)
                        <tr class="shadow" style="cursor: pointer">
                            <td class="num">
                                {{ $attestation->numAttestation }}
                            </td>
                            <td class="nom">
                                {{ $attestation->numInscrit }}
                            </td>
                            <td class="prenoms">
                                {{ $attestation->nom }}
                            </td>
                            ...
                            <td class="prenoms">
                                {{ date("d/m/Y", strtotime($attestation->dateDelivrance)) }}
                            </td>

                            <td>
                                @if($loop->last)
                                    <div class="flex flex-row">
                                        <button wire:click="confirmAttestation({{ $attestation->id }}, {{ $attestation->numAttestation}})"
