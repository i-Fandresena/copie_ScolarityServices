...
@section('content')
    <div class="content flex justify-center items-center h-screen">
        <form method="POST" action="{{ route('registerUser') }}" class="rounded-lg border shadow-md p-5  mb-5">
            @csrf
            <div class="mb-4">
            ...
            <p for="role-select" class="font-semibold text-gray-700">Utlisateur veux être :</p>
